...
public class EntitySelectionUI {
    ...
    public void create(IItemService itemService) {
    ...
    public void remove() {
        GameResources.get().getEngine().removeEntity(bottomLeft);
        GameResources.get().getEngine().removeEntity(bottomRight);
        GameResources.get().getEngine().removeEntity(topLeft);
        GameResources.get().getEngine().removeEntity(topRight);
    }
