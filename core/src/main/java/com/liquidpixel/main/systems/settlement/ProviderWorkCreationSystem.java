...
public class ProviderWorkCreationSystem extends IntervalIteratingSystem {
    ...
    public ProviderWorkCreationSystem(IStorageService storageService) {
    ...
    protected void processEntity(Entity entity) {
        ...
        IStorageItem item = storageService.getAnyItemICanCarry(storage);
        ...
        if (item != null && item.getQuantity() > 0) {
            ...
            try {
                ...
                if (storageService.isItemQuantityAvailable(storage, new StorageItem(item.getName(), quantity, item.getStackSize(), item.getSprite()))) {
                    ...
                    for (Entity storageLocation : storageLocations) {
                        ...
                        StorageQueryResult result = storageService.isThereEnoughSpaceForItem(storageLocation, item, storageWorkOrders);
