...
public abstract class PoolableTaskManager {
    ...
    public Set<PoolableTask> getPoolableTasks() {
        return poolableTasks;
    }

    public List<PoolableTask> getScheduledForRemoval() {
        return scheduledForRemoval;
    }

    public List<PoolableTask> getScheduledForAddition() {
