...
/** An {@link InputProcessor} that allows you to manually move a {@link com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor}.
 *
 * @autor davebaol */
public class Scene2dTargetInputProcessor extends InputAdapter {
	protected com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor target;
