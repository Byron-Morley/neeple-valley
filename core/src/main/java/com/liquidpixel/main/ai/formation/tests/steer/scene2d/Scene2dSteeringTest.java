...
package com.liquidpixel.main.ai.formation.tests.steer.scene2d;
...
import com.liquidpixel.main.ai.formation.tests.SteeringBehaviorsTest;
import com.liquidpixel.main.ai.formation.tests.steer.SteeringTestBase;
import com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor;
...
public abstract class Scene2dSteeringTest extends SteeringTestBase {
	...
	protected void addAlignOrientationToLinearVelocityController (Table table, final com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor character) {
	...
	protected void setRandomNonOverlappingPosition (com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor character, Array<com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor> others,
		...
		while (--maxTries >= 0) {
			...
			for (int i = 0; i < others.size; i++) {
				com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor other = (com.liquidpixel.main.ai.formation.tests.steer.scene2d.SteeringActor)others.get(i);
